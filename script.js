(() => {
  ...
  const initContactForm = () => {
    ...
    form.addEventListener("submit", (event) => {
      ...
      status.textContent = "Solicitud preparada correctamente. Abriremos tu cliente de correo para enviarla al equipo comercial de NexoMatrix. Si no se abre, por favor escríbenos a ale.voo28@gmail.com";
      status.classList.add("is-success");
      window.location.href = `mailto:ale.voo28@gmail.com?subject=${subject}&body=${body}`;
      form.reset();
